...
K_pz = 5
K_pt = -15
dx_des_ = 0.0 # will be overwritten by keyboard input or controller 
dy_des_ = 0.0 # will be overwritten by keyboard input or controller 
dz_omega_ = 0.0
dy_rocking = 0.1
...
class Walking_controller():
    ...
    def step(self, contact_l, contact_r, q, dx_des, dy_des, dz_omega, t):
        ...
        if self.stance["stance"] == "Right":
            return {"right_hip_z": dq_stance[0,0], "right_hip_y": dq_stance[1,0], "right_hip": dq_stance[2,0], "right_knee": dq_stance[3,0], "left_hip_z": dq_swing[0,0], "left_hip_y": dq_swing[1,0], "left_hip": dq_swing[2,0], "left_knee": dq_swing[3,0]}
        else:
            return {"left_hip_z": dq_stance[0,0], "left_hip_y": dq_stance[1,0], "left_hip": dq_stance[2,0], "left_knee": dq_stance[3,0], "right_hip_z": dq_swing[0,0], "right_hip_y": dq_swing[1,0], "right_hip": dq_swing[2,0], "right_knee": dq_swing[3,0]}



model = mujoco.MjModel.from_xml_path("xml_files/biped_3d_5dof_leg.xml")
...
with mujoco.viewer.launch_passive(model, data) as viewer:
    ...
    while viewer.is_running():
        ...
        data.ctrl[ctrl_r_hip_z] = np.clip(dq_c["right_hip_z"], -5, 5)
        ...
        data.ctrl[ctrl_r_foot] = 0.0

        data.ctrl[ctrl_l_hip_z] = np.clip(dq_c["left_hip_z"], -5, 5)
